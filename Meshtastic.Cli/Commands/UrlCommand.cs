...
public class UrlCommand : Command
{
    ...
    {
        var urlOperationArgument = new Argument<GetSetOperation>("operation", "The type of url operation");
        urlOperationArgument.AddCompletions(ctx => Enum.GetNames(typeof(GetSetOperation)));
