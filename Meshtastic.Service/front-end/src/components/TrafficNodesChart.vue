...
import { numToColor } from '../converters/NumToColor'

Chart.register(...registerables)
const dashboardStore = useDashboardStore()

const traffic = ref(dashboardStore.dashboard?.trafficByNode || [])
  ...
  datasets: [
    {
      ...
      backgroundColor: traffic.value.map(t => numToColor(t.id)),
    },
  ]
}))
</script>